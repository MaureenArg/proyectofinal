...
// Capa raster de bio14 precipitacion meses mas secos
var capa_bio14 = L.imageOverlay("https://raw.githubusercontent.com/MaureenArg/datostarea/master/bio_14cr.png", 
	[[11.2182124295523433, -87.0996671226630781], 
	[5.5029808209751785, -82.5564197173637666]], 
	{opacity:0.3}
).addTo(mapa);

control_capas.addOverlay(capa_bio14, 'Precipitación del mes más seco');

function updateOpacitybio14() {
  document.getElementById("span-opacity-bio14").innerHTML = document.getElementById("sld-opacity-bio14").value;
  capa_bio14.setOpacity(document.getElementById("sld-opacity-bio14").value);
